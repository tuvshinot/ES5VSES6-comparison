...
// ES6
{
    const a = 1;
    let b = 2;
    var c = 3; // that works cuz they are function scoped
}
...
var box5 = {
    ...
    clickMe: function() {
       ...
       var self = this; /// SEEEEEEEEEEEEEEEE hack this below does not work so , stored in different var 
...
const box6 = {
    ...
    position: 1,
    clickMe: function() {
        document.querySelector('.green').addEventListener('click', () => {   // using arrow function, we can use this keyword
...
Person.prototype.myFriends5 = function(friends) {
    ...
    }.bind(this));   /////////////////////////////////// create copy of method and pre set the 'this' keyword to this!!
...
for(var i = 0; i < boxesArr5.length; i++) {
    ...
    if(boxesArr5[i].className === 'box blue') { //// !!!!!!!!!!!!!!!!!!! class name property!!!!!!!!!!!!!!!
...
for (const cur of boxesArr6) {
    if (cur.className.includes('blue')) { /// !!!!!!!!!!!!!!classname.include property
        continue;
    }
...
//ES6
const sum3 = addFourAges(...ages); // expand array to elements
console.log(sum3);
...
function isFullAge5() {
    ...
    var argsArr = Array.prototype.slice.call(arguments); // arguments is keywords that points to 
                                                        // arguments of function it return similar to array but not
...
//ES6
function isFullAge6(...years) {  // it is gonna transform whatever it takes from function arguments to array!!!!
...
function isFullAge5(limit) {
    var argsArr = Array.prototype.slice.call(arguments, 1); // cuts from position 1 //
...
isFullAge6(16, 1990, 1999, 1965, 2016, 1987); first element is limit
...
function SmithPerson(firstName, yearOfBirth, lastName, nationality) {
    ...
    lastName === undefined ? lastName = 'Smith' : lastName = lastName; // default para
...
//ES6
function SmithPerson(firstName, yearOfBirth, lastName = 'Smith', nationality = 'american') { //default para
    this.firstName = firstName;
    this.lastName = lastName;
    this.yearOfBirth = yearOfBirth;
    this.nationality = nationality;
...
if(question.has(4)) { // check 
    //question.delete(4);  // delete
...
for (let [key, value] of question.entries()) { // entries returns all key value pair so that we can use key & value 
    if (typeof(key) === 'number') {  // typeOf variable
        console.log(`Answer ${key}: ${value}`);
    }
}

const ans = parseInt(prompt('Write the correct answer'));
console.log(question.get(ans === question.get('correct'))); // you need to pay attention to this so cool stuff on boolen!!!!
*/
...
class Person6 {
    ...
    static greeting() {   // static so , jon6. not inherited!!!! instances not inherited
...
class Athlete6 extends Person6 {
    constructor(name, yearOfBirth, job, olympicGames, medals) {
        super(name, yearOfBirth, job); // super constructor is constructor of Person6
...
//===========================================native code ======================================
String.prototype.myIncludes = function(el) {
...
String.prototype.mystartsWith = function(el) {
...
String.prototype.myendsWith = function(el) {
     
    if(this[this.length - 1] === el) {
        return true;
    } else {
        return false;
    }
